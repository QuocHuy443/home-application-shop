                ...
                <form action="/login" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="username_email" class="form-control border-start-0 rounded-end-3"
                                value="<?= htmlspecialchars($username_email) ?>" placeholder="nhapemail@example.com"
                                required autofocus>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn btn-light border border-start-0 text-muted rounded-end-3" type="button"
